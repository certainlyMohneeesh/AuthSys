...
export async function POST(req) {
    try {
        ...
        if (!user) {
            ...
            return NextResponse.json({ message: "Welcome email will be sent if the account exists" }, { status: 200 });
        }
        ...
        if (!emailSent) {
            ...
            if (process.env.NODE_ENV === 'development') {
                ...
                console.log("==============================\n");
                return NextResponse.json({ message: "Welcome email sent successfully (development mode)" }, { status: 200 });
            }
